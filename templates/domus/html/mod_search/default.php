...
<form action="<?php echo JRoute::_('index.php');?>" method="post" class="navbar-form navbar-right">
...
//                        $output = '<label for="mod-search-searchword" class="element-invisible">' . $label . '</label> ';
                        ...
                        if ($button) :
                                if ($imagebutton) :
                                        ...
                                        $btn_output = ' <button class="btn btnSearch" onclick="this.form.searchword.focus();"><i class="fa fa-search"></i></button>';
                                endif;
